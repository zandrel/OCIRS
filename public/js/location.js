    ...
    $.extend(Plugin.prototype, {
        ...
        fetch_list: function (filter) {
            ...
            if (this.settings.location_type == "regions") {
                filterfieldname = "Select your Region";
            } else if (this.settings.location_type == "provinces") {
                filterfieldname = "Select your Province";
            } else if (this.settings.location_type == "cities") {
                filterfieldname = "Select your City/Municipality";
            } else {
                filterfieldname = "Select your Barangay";
            };
